...
export const metadata: Metadata = {
  ...
  description: 'Download 80+ free R&B samples and loops. Smooth melodies, modern chords, and silky vocals for R&B music production. Royalty-free with commercial licenses.',
