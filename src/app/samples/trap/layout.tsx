...
export const metadata: Metadata = {
  ...
  description: 'Download 89+ free trap samples and loops. Hard-hitting 808s, hi-hats, and dark melodies for trap music production. Royalty-free with commercial licenses.',
